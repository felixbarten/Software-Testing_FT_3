...
> algDistribution(Dsj [f1,Cnj[ f2, f3]]) = Cnj[algDistribution (Dsj[algDistribution f1,algDistribution f2]), (Dsj[algDistribution f1,algDistribution f3])]

> algDistribution(Dsj [Cnj[ f1, f2], f3]) = Cnj[algDistribution (Dsj[algDistribution f1,algDistribution f3]),(Dsj[algDistribution f2,algDistribution f3])]
...
> cnf :: Form -> Form
> cnf x = ( algDistribution . nnf . arrowfree ) x
